...
processChannel("C1-" + avg_title, "Cyan", "Comp", 20, 4000);
processChannel("C2-" + avg_title, "Green", "Nd6", 20, 4000);
processChannel("C3-" + avg_title, "Yellow", "Tub", 20, 4000);

/////////////////////////////////////// Merge Section ///////////////////////////////////////

// Merging three channels using the saved filenames
merg_arg = "c1=[" + title_wo_ext + "_Comp_s" + slice_nb + ".tiff] " +
           "c2=[" + title_wo_ext + "_Nd6_s" + slice_nb + ".tiff] " +
           "c3=[" + title_wo_ext + "_Tub_s" + slice_nb + ".tiff] create";
